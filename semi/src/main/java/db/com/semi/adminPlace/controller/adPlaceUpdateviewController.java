...
/**
 * Servlet implementation class adPlaceUpdateController
 */
@WebServlet("/AdPlaceupdate.au")
public class adPlaceUpdateviewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adPlaceUpdateviewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/adminPlace/adminPlaceUpdateView.jsp").forward(request, response);;
