...
public class Attechment {
	...
	private int placeNo;
	public Attechment(int fileNo, String originName, String changeName, String filePath, int fileLevel, int placeNo) {
		super();
		this.fileNo = fileNo;
	...
	public String toString() {
		return "Attechment [fileNo=" + fileNo + ", originName=" + originName + ", changeName=" + changeName
				+ ", filePath=" + filePath + ", fileLevel=" + fileLevel + ", placeNo=" + placeNo + "]";
	}
