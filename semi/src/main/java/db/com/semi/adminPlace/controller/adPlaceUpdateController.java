 ...
 */
@WebServlet("/AdPlaceupdatec.up")
public class adPlaceUpdateController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adPlaceUpdateController() {
        super();
...
System.out.println(pno);
		...
		int result = new adPlaceService().updatePlace(p,list, pno);
		if(result>0) {
		}else {
		}
