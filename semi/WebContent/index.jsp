...
<% // 음식점 swiper 
    ...
    RankingService ranService = new RankingService();  // 명예의전당
...
.play-slide .inner .swiper-prev .material-icons, .play-slide .inner .swiper-next .material-icons
	{
	font-size: 35px;
	color: #e4d4fa;
}
...
.food-slide .inner .swiper-prev .material-icons, .food-slide .inner .swiper-next .material-icons
	{
	font-size: 35px;
	color: #e4d4fa;
}
...
<body>
		...
		<div class="inner">
			<div class="swiper-container">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<a target="_blank" href="https://ges.seoul.kr/"> <img
	...
	<div class="inner fame-area">
		...
		<div class="fame-name" id="fame-1-name">
			<a
				href="<%= contextPath %>/detail.co?bno=<%= rankList.get(0).getcNO() %>"><%= rankList.get(0).getNickName() %></a>
		</div>
		<%}else{ %>
		<div class="fame-name" id="fame-1-name">
			<a
				href="<%= contextPath %>/detail.co?bno=<%= rankList.get(0).getcNO() %>"><%= rankList.get(0).getUserName() %></a>
		</div>
		...
		<div class="fame-name" id="fame-2-name">
			<a
				href="<%= contextPath %>/detail.co?bno=<%= rankList.get(1).getcNO() %>"><%= rankList.get(1).getNickName() %></a>
		</div>
		<%}else{ %>
		<div class="fame-name" id="fame-2-name">
			<a
				href="<%= contextPath %>/detail.co?bno=<%= rankList.get(1).getcNO() %>"><%= rankList.get(1).getUserName() %></a>
		</div>
		...
		<div class="fame-name" id="fame-3-name">
			<a
				href="<%= contextPath %>/detail.co?bno=<%= rankList.get(2).getcNO() %>"><%= rankList.get(2).getNickName() %></a>
		</div>
		<%}else{ %>
		<div class="fame-name" id="fame-3-name">
			<a
				href="<%= contextPath %>/detail.co?bno=<%= rankList.get(2).getcNO() %>"><%= rankList.get(2).getUserName() %></a>
		</div>
	...
	<footer>
		<div class="inner">
			...
			<div class="info">
				<span>kh H반 4조</span> <span>semi4jyo@gmail.com</span> <span>개인정보
					책임자 4조</span>
