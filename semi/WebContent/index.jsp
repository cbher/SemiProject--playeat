<%@page import="semi.play.model.service.PlayService"%> <%@page
import="semi.play.model.vo.Play"%> <%@page
import="semi.ranking.model.service.RankingService"%> <%@page
import="semi.ranking.model.vo.Ranking"%> <%@page
import="semi.restaurant.model.dao.RestaurantDao"%> <%@page
import="semi.restaurant.model.service.RestaurantService"%> <%@page
import="semi.restaurant.model.vo.Restaurant"%> <%@page
import="semi.cooking.model.vo.CookingBoard"%> <%@page
import="java.util.ArrayList"%> <%@ page language="java" contentType="text/html;
charset=UTF-8" pageEncoding="UTF-8"%> <% // 음식점 swiper RestaurantService
restService = new RestaurantService(); ArrayList<Restaurant>
  rlist = restService.mainPageSelectRestaurnt(); // 놀거리 swiper PlayService
  playService = new PlayService(); ArrayList<Play>
    pList = playService.mainPageSelectPlay(); ArrayList<Play>
      playList = new PlayService().selectPlayList(); // 명예의전당
      RankingService ranService = new RankingService(); ArrayList<Ranking>
        rankList = ranService.selectTop3(); Ranking rank1 = rankList.get(0); //
        첫 번째 항목 Ranking rank2 = rankList.get(1); // 두 번째 항목 Ranking
        rank3 = rankList.get(2); // 세 번째 항목 %>
        ...
        <html>
          <head>
            ...
            <style>
              ...
              .fame-area {
                ...
                align-items: center;
                width: 1100px;
                background-image: url(./resources/backGroundImg/명전_뒷배경\\(
                    1\
                  ).png);
                height: 800px;
                border-radius: 12px;
          ...
          <body>
            <%@ include file="views/common/menubar.jsp" %> <%@ include
            file="views/common/badge.jsp" %>
                ...
                <div class="swiper-container">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a
                        target="_blank"
                        href="https://korean.visitkorea.or.kr/kfes/detail/fstvlDetail.do?cmsCntntsId=2755115"
                      >
                        <img
                          src="./resources/main_upfiles/19cc361a-c05f-4763-bdde-4158eba088e2_3.jpg"
                          alt=""
                        />
                        <p>고양시 축제</p>
                      </a>
                    ...
                    <div class="swiper-slide">
                      <a
                        target="_blank"
                        href="https://www.accf.or.kr/main/event/musicsociety2024"
                      >
                        <img
                          src="./resources/main_upfiles/motion_poster.gif"
                          alt=""
                        />
                        <p>월드뮤직페스티벌 2024</p>
                      </a>
                    ...
                    <div class="swiper-slide">
                      <a
                        target="_blank"
                        href="https://www.sejongpac.or.kr/portal/bbs/B0000057/view.do?nttId=48114&bbsId=B0000057&menuNo=200502"
                      >
                        <img
                          src="./resources/main_upfiles/8be85dd0-3223-4e21-9cf8-57b3b429db66_3.jpg"
                          alt=""
                        />
                        <p>세종썸머페스티벌</p>
                      </a>
                    ...
                    <div class="swiper-slide">
                      <a
                        target="_blank"
                        href="https://blog.naver.com/981jeju/223249501930"
                      >
                        <img
                          src="./resources/main_upfiles/220371a8-ec85-46b7-8bb0-30afa9a93a19_3.png"
                          alt=""
                        />
                        <p>구팔일댕댕이라이딩</p>
                      </a>
                    ...
                    <div class="swiper-slide">
                      <a target="_blank" href="https://ges.seoul.kr/">
                        <img
                          src="./resources/main_upfiles/7dda978f-bd69-46f6-b31c-6e1e318249f5_3.jpg"
                          alt=""
                        />
                        <p>서울 E-sport 축제</p>
                      </a>
              ...
              <div class="inner">
                ...
                <div class="swiper-container">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <a
                        href="<%= contextPath %>/detail.pl?bno=<%= p.getPlaceNo() %>"
                      >
            ...
            <div class="inner fame-area">
              ...
              <div id="fame-1">
                <a
                  href="<%= contextPath %>/detail.co?bno=<%= rankList.get(0).getcNO() %>"
                >
              ...
              <div id="fame-2">
                <a
                  href="<%= contextPath %>/detail.co?bno=<%= rankList.get(1).getcNO() %>"
                >
              ...
              <div id="fame-3">
                <a
                  href="<%= contextPath %>/detail.co?bno=<%= rankList.get(2).getcNO() %>"
                >
