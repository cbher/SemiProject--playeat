      ...
      <div class="info-box">
        ...
        <div class="swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="./resourse/음식.jpg" alt=""></div>
            <div class="swiper-slide"><img src="./resourse/아이유.jpg" alt=""></div>
            <div class="swiper-slide"><img src="./resourse/조이.jpg" alt=""></div>
            <div class="swiper-slide"><img src="./resourse/카리나.jpg" alt=""></div>
            <div class="swiper-slide"><img src="./resourse/방탈출.jpg" alt=""></div>
          </div>
        ...
        <div class="info">
          <div class="info2">
            ...
            <div class="info-btn">
            <a href="" id="like">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#e4d4fa" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
            ...
            <button type="button" class="modal_btn">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#e4d4fa" class="bi bi-share-fill" viewBox="0 0 16 16">
            ...
            <div class="modal">
              <div class="modal_popup">
                ...
                <div>
                  ...
                  <a href=""><img src="./resourse/kakao-talk_3991999.png" alt=""></a>
                </div>
      ...
      <div class="comment">
        ...
        <div id="myModal" class="comment-modal">
          <div class="modal-content">
            ...
            <br>
            <textarea name="" id="" class="star-content" style="resize: none;" placeholder="입력하세요."></textarea>
          </form>
          </div>
        </div>
