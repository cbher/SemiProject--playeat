    ...
    <div id="wrap">
        <div id="content">
            <div id="content_title">
                ...
                <a href="<%=contextPath %>/onecomment.1">찜 리스트</a>
           ...
           <div class="">
            ...
            <div id="fbox">
                ...
                <input type="checkbox"><label>카테고리1</label>
                <input type="checkbox"><label>카테고리2</label>
                <input type="checkbox"><label>카테고리3</label>
                <input type="checkbox"><label>카테고리4</label>
                <input type="checkbox"><label>카테고리5</label>
                <input type="checkbox"><label>카테고리6</label>
                <input type="checkbox"><label>카테고리7</label>
                <div><img src="/마이페이지/resource/프로젝트 로고.png" id="ficon" alt=""></div>

            </div>
            <div id="food_box">
                <input type="checkbox"><label>한식</label><br>
                <input type="checkbox"><label>분식</label><br>
                <input type="checkbox"><label>일식</label>
            </div>
