...
<html>
  ...
  <body>
    ...
    <div class="main" align="center">
      <br />
      <h2>장소 추가</h2>
      <form action="AdPlaceInsert.ap" method="post" enctype="multipart/form-data">
        <table>
          <tr>
            <th width="90" height="30">가게명</th>
            <td width="260">
              <input type="text" name="ptitle" placeholder="가게명을 입력해주세요" />
            </td>
            <th width="90">가게번호</th>
            <td width="300">
              <input type="text" name="pcall" placeholder="가게번호를 입력해주세요" />
            </td>
          </tr>
          <tr>
            <th height="35">가게주소</th>
            <td colspan="3">
              <input type="text" name="address" placeholder="가게주소를 입력해주세요" />
            </td>
          </tr>
          <tr>
            <th height="30">테마</th>
            <td>
              <select name="tCate" id="">
