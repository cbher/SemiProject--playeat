          ...
          <h2>원클래스 수정하기</h2>
            <table>
              ...
              <tr>
                ...
                <script >
                document.getElementById("areaSelect").value =  <%=list.getLocationNo()%>
                </script>
               </td>
              </tr>
              <tr>
                <th height="30">제목</th>
                <td colspan="3"> <input name="onetitle" value=" <%=list.getOneTitle() %>"> </td>
             
              </tr>
              <tr>
                <th>최대인원</th>
                <td>
                <input type="number" value="<%=list.getEntPeople() %>" name="entpeople">
                ...
                <script >
                document.getElementById("temCateSelect").value = <%=list.getTemCateNo() %>
                </script>
               ...
               <tr>
                ...
                <script >
                document.getElementById("oneCateSelect").value = <%=list.getOnecategoryNo() %>
                </script>
                ...
                <th>가격</th>
                <td>
                   <input type="number" value="<%=list.getPrice() %>" name="price">
               ...
               <tr>
                <th>장소</th>
                <td colspan="3" >
                  <input type="text" value="<%=list.getOnePlace() %>" name="onePlace" />
               ...
               <tr>
                <th>시작시간</th>
                <td>
                <input type="time" value="<%=list.getStartTime() %>" name="startTime">
              
                </td>
                <th>종료시간</th>
                <td>
                   <input type="time" value="<%=list.getStartTime() %>" name="endTime">
